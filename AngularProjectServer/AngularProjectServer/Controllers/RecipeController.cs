...
namespace AngularProjectServer.Controllers
{
  ...
  public class RecipeController : ControllerBase
  {
    ...
    public static List<Recipe> recipes = new List<Recipe>
     ...
     new Recipe {
        RecipeId = 1,
        RecipeName = "Lemon caramel chocolate cake",
        CategoryId = 1,
        PreparationTimeInMinutes = 45,
        DifficultyLevel = 1,
        CreationDate = DateTime.Now,
     ...
     new Recipe {
        RecipeId = 3,
        RecipeName = "Salted caramel cream cookies",
        CategoryId = 2,
     ...
     new Recipe
      {
        RecipeId = 4,
        RecipeName = "Cheese delicacy with chocolate",
        CategoryId = 1,
...
"Heating the oven to 175°C",
     ...
     new Recipe
      {
        RecipeId = 6,
        RecipeName = "'Milfay'cream and cream cheese",
        CategoryId = 4,
        PreparationTimeInMinutes = 45,
        DifficultyLevel = 2,
        CreationDate = DateTime.Now,
...
{
    RecipeId = 7,
    RecipeName = "Cheese and cream apple tart",
    CategoryId = 1,
    PreparationTimeInMinutes = 45,
    DifficultyLevel = 2,
    CreationDate = DateTime.Now,
...
{
    RecipeId = 11,
    RecipeName = "Chocolate pie and coffee ganache",
    CategoryId = 2,
...
{
    RecipeId = 13,
    RecipeName = "Vanilla and honey dessert",
    CategoryId = 2,
    PreparationTimeInMinutes = 45,
    DifficultyLevel = 3,
    CreationDate = DateTime.Now,
...
{
    RecipeId = 14,
    RecipeName = "Cherry dark chocolate mousse",
    CategoryId = 2,
    PreparationTimeInMinutes = 45,
    DifficultyLevel = 3,
    CreationDate = DateTime.Now,
